...
"[project]/lib/models/invite.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/mongoose [external] (mongoose, cjs)");
;
const InviteSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Schema({
    email: {
        type: String,
        required: true,
        unique: true
...
const Invite = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].models.Invite || __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model("Invite", InviteSchema);
...
"[project]/app/api/users/[email]/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$invite$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/models/invite.js [app-route] (ecmascript)");
...
async function OPTIONS() {
    return new Response(null, {
        status: 204,
        headers: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$layout$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]
    });
}
async function GET(req, { params }) {
    ...
    try {
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$user$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            email: userEmail
        });
        if (!user) {
...
async function PUT(req, { params }) {
    ...
    try {
        ...
        const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$user$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndUpdate({
            email: userEmail
        }, body, {
            new: true
        });
...
async function DELETE(req, { params }) {
    ...
    try {
        const userEmail = decodeURIComponent(email);
        const deletedUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$user$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndDelete({
            email: userEmail
        });
        const deletedInvite = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$invite$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndDelete({
            email: userEmail
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__557db190._.js.map