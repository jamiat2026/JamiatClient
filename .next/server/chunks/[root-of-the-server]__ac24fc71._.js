...
async function GET() {
    ...
    try {
        const users = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$user$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find().sort({
            createdAt: -1
        });
...
async function POST(req) {
    ...
    try {
        ...
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$user$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOne({
            email
        });
        if (existing) {
            return new Response(JSON.stringify({
        ...
        const user = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$models$2f$user$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
            email,
            name,
            role,
            access
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ac24fc71._.js.map