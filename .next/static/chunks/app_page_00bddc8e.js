        ...
        "DashboardPage.useEffect": ()=>{
            async function fetchData() {
                ...
                donationData.forEach({
                    "DashboardPage.useEffect.fetchData": (don)=>{
                ...
                months.sort();
                const monthlyDonations = months.map({
                    "DashboardPage.useEffect.fetchData.monthlyDonations": (m)=>monthly[m]
                }["DashboardPage.useEffect.fetchData.monthlyDonations"]);
                setSummary({
                    activeCount: projectData.activeCount,
                    completedCount: projectData.completedCount,
                    totalDonors: donorData.length,
                    totalDonations: donationData.reduce({
                        "DashboardPage.useEffect.fetchData": (sum, d)=>sum + (d.amount || 0)
                    }["DashboardPage.useEffect.fetchData"], 0),
                    monthlyDonations,
                    months
                });
            }
...
_s(DashboardPage, "wAkg8QxKFNJsidz6PNop1/D0Tmc=");
_c = DashboardPage;
var _c;
